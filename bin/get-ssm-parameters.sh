...
PROJECT_CANONICAL_NAME="local-elections" # must be set to each project's "Final naming convention" from here https://github.com/hackoregon/civic-devops/issues/1
